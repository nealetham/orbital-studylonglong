...
import { Text, View, TouchableHighlight, Image, FlatList, Pressable } from "react-native";
...
export default function Timer() {
    const [visibleDumplingSelection, setVisibleDumplingSelection] = React.useState(false);
        ...
        <View style={{
            ...
            <View style={globalStyles.timerContainer}>
                ...
                <TouchableHighlight onPress={toggleDumplingSelectionView}>
                    <Image style={globalStyles.pic} source={require('../../assets/long-default-pau.png')} />
                </TouchableHighlight>
                        ...
                        renderItem={({item}) => 
                            <View style={globalStyles.singleListItem}>
                                ...
                                <Pressable
                                    ...
                                    onPress={() => {setTime(item.minutes, item.seconds)}}
                                    onLongPress={() => {removeItem(item.title)}}
                                >
                                    <Text style={globalStyles.singleTimerTime}>
                                        {String(item.minutes).padStart(2, "0") + ":" + String(item.seconds).padStart(2, "0")}
                                    </Text>
                                </Pressable>
                            </View>
                        }
